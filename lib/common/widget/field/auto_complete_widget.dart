...
class FilterableList<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color suggestionBackgroundColor = this.suggestionBackgroundColor ?? scaffold?.widget.backgroundColor ?? theme.scaffoldBackgroundColor;
          ...
          child: Scrollbar(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (loading) {
                  return Container(alignment: Alignment.center, padding: const EdgeInsets.all(10), child: progressIndicatorBuilder!);
                }
