      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            fontSize: isMobile ? 14 : 16.spMin,
            color: foreground,
            height: 1.3.wMax,
          ),
        ),
        (isMobile ? 6 : 12.w).hSpace,
        ...List.generate(
          data.length,
          (index) {
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(
                        top: 4.spMax,
                        right: isMobile ? 6 : 14.wMin,
                      ),
                      child: Icon(
                        Icons.circle,
                        color: foreground,
                        size: isMobile ? 6 : 7.spMin,
                      ),
                    ),
                  ),
                  Expanded(
    ...
    return Column(
      ...
      children: [
        ...
        Visibility(
          visible: this == sales,
          child: Padding(
            padding: EdgeInsets.only(top: isMobile ? 6 : 12.wMin),
            child: Wrap(
              runSpacing: isMobile ? 6 : 12.wMin,
